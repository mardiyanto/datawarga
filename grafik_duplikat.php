...
$queryKecamatan = "SELECT kecamatan, COUNT(*) AS jumlah FROM warga GROUP BY kecamatan";
...
$queryTotal = "SELECT COUNT(*) AS total_data FROM warga";
...
function displayJumlahWargaKecamatan(kecamatan) {
    $.ajax({
        url: 'get_jumlah_warga_kecamatan_duplikat.php',
        type: 'POST',
...
$('#kecamatanDropdown').change(function() {
    ...
    if (selectedKecamatan) {
        ...
        $.ajax({
            url: 'get_data_desa_duplikat.php',
            type: 'POST',
